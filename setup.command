...
##
# InsanelyDeepak 
# Script to setup Mac/Hackintosh for first time 
#
#
##
...
#
# install it:
#   clone or download as zip and double click setup.command file
#
...
# Disable “natural” scrolling to Scrolling as in windows
...
defaults write NSGlobalDomain AppleLocale -string "en_IN@currency=INR"
...
tell application "Terminal"
	...
	do shell script "open '$HOME/resource/" & themeName & ".terminal'"
...
open "${HOME}/resource/Solarized Dark.itermcolors"
...
cp -r resource/Preferences.sublime-settings ~/Library/Application\ Support/Sublime\ Text*/Packages/User/Preferences.sublime-settings 2> /dev/null
...
cp -r resource/spectacle.json ~/Library/Application\ Support/Spectacle/Shortcuts.json 2> /dev/null
...
# Change theme to Dusk (choose whichever you like)
